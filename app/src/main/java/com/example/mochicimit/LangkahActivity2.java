...
public class LangkahActivity2 extends AppCompatActivity { // 2. Ubah extends menjadi AppCompatActivity
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (tombolKembali != null) {
            tombolKembali.setOnClickListener(v -> {
                // finish() adalah perintah untuk menutup Activity saat ini (LangkahActivity2)
                // dan secara otomatis akan kembali ke Activity sebelumnya (DetailResepActivity2).
                finish();
            });
        }
        // =====================================================================
